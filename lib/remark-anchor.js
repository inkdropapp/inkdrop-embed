...
function createRemarkAnchor(OrigA) {
  ...
  return _class = class RemarkAnchor extends React.Component {
    render() {
      const {
        href,
        children
      ...
      if (OrigA) {
        return /*#__PURE__*/React.createElement(OrigA, this.props, children);
      } else {
        return /*#__PURE__*/React.createElement("a", this.props, children);
      }
    }
